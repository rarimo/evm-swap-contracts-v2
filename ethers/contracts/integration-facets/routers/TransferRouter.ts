...
export interface TransferRouterInterface extends utils.Interface {
  functions: {
...
export interface TransferRouter extends BaseContract {
  contractName: "TransferRouter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TransferRouterInterface;
