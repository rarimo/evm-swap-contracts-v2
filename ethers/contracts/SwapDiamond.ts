...
export interface SwapDiamondInterface extends utils.Interface {
  functions: {
    ...
    "addFacet(address,bytes4[],uint8[])": FunctionFragment;
    ...
    "updateFacet(address,bytes4[],bytes4[],uint8[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "updateFacet(address,bytes4[],bytes4[],uint8[])"
  ...
  encodeFunctionData(
    functionFragment: "addFacet(address,bytes4[],uint8[])",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "updateFacet(address,bytes4[],bytes4[],uint8[])",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>[],
      PromiseOrValue<BytesLike>[],
...
export interface SwapDiamond extends BaseContract {
  contractName: "SwapDiamond";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapDiamondInterface;
  ...
  functions: {
    ...
    "updateFacet(address,bytes4[],bytes4[],uint8[])"(
      ...
      toTypes_: PromiseOrValue<BigNumberish>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
