...
export interface UUPSSignableUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface UUPSSignableUpgradeable extends BaseContract {
  contractName: "UUPSSignableUpgradeable";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UUPSSignableUpgradeableInterface;
