...
export interface IBridgeFacadeInterface extends utils.Interface {
  functions: {
...
export interface IBridgeFacade extends BaseContract {
  contractName: "IBridgeFacade";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IBridgeFacadeInterface;
