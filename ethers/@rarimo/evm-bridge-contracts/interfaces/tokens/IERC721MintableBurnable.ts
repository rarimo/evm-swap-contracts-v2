...
export interface IERC721MintableBurnableInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "mintTo(address,uint256,string)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>
...
export interface IERC721MintableBurnable extends BaseContract {
  contractName: "IERC721MintableBurnable";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721MintableBurnableInterface;
