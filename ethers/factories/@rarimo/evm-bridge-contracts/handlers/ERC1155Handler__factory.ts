...
import type {
  ERC1155Handler,
  ERC1155HandlerInterface,
} from "../../../../@rarimo/evm-bridge-contracts/handlers/ERC1155Handler";
...
export class ERC1155Handler__factory {
  static readonly abi = _abi;
  static createInterface(): ERC1155HandlerInterface {
    return new utils.Interface(_abi) as ERC1155HandlerInterface;
  }
  static connect(
    address: string,
