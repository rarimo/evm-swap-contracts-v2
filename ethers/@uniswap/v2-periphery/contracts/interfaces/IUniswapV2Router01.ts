...
export interface IUniswapV2Router01Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "removeLiquidityETHWithPermit(address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
